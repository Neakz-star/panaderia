...
app.post('/agregarUsuario',(req,res)=>{
        ...
        con.query('INSERT INTO usuraio (id_usuario, nombre) VALUES (?, ?)', [id, nombre], (err, respuesta, fields) => {
            if (err) {
...
app.get('/obtenerUsuario',(req,res)=>{
    con.query('select * from usuraio', (err,respuesta, fields)=>{
...
app.post('/borrarUsuario', (req, res) => {
    ...
    console.log("hola")
    con.query('DELETE FROM usuraio WHERE id_usuario = ?', [id], (err, resultado, fields) => {
